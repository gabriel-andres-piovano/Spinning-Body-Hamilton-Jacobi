...
(* ::Text:: *)
(*Unlike the vanilla version "SpinOrbitsHamiltonJacobi.wl", in this version there are no Chop[,10^-16] functions in Fourier series expansions to set to zero terms smaller than the threshold 10^-16. The current version is used  to test how the  the asymptotic partial amplitudes are affected by the maximum number of harmonics in the Fourier series kept in the orbits.*)
...
V\[Phi]rgcoeff[nmax_,a_,p_,e_,xg_,const_]:=Module[{stepsr,wrlist,V\[Phi]rglist,ExpniTable},
	...
	ExpniTable=Table[N[Exp[2Pi*I*n*(i-1/2)/stepsr],Precision[{a,p,e,xg}]],{n,-nmax,nmax},{i,1,stepsr}];
	(ExpniTable . V\[Phi]rglist)/stepsr
]
...
V\[Phi]zgcoeff[kmax_,a_,p_,e_,xg_,const_]:=Module[{stepsz,wzlist,V\[Phi]zglist,ExpjkTable},
	...
	ExpjkTable=Table[N[Exp[2Pi*I*k*(j-1/2)/stepsz],Precision[{a,p,e,xg}]],{j,1,stepsz},{k,-kmax,kmax}];
	(V\[Phi]zglist . ExpjkTable)/stepsz	
]
...
\[Delta]YroverYrgsparFCcoeff[nmax_,kmax_,a_,p_,e_,xg_,const_]:=Module[{stepsr,stepsz,wrlist,wzlist,ExpniTable,ExpjkTable},
	...
	(ExpniTable . (Table[\[Delta]YroverYrgsparFC[wrlist[[i]],wzlist,a,p,e,xg,const],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz)
]
...
\[Delta]YroverYrgsparDHcoeff[nmax_,kmax_,a_,p_,e_,xg_,const_,\[Delta]const_]:=Module[{stepsr,stepsz,wrlist,wzlist,ExpniTable,ExpjkTable},
	...
	(ExpniTable . (Table[\[Delta]YroverYrgsparDH[wrlist[[i]],wzlist,a,p,e,xg,const,\[Delta]const],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz)
]
...
\[Delta]YzoverYzgsparFCcoeff[nmax_,kmax_,a_,p_,e_,xg_,const_]:=Module[{stepsr,stepsz,wrlist,wzlist,ExpniTable,ExpjkTable},
	...
	(ExpniTable . (Table[\[Delta]YzoverYzgsparFC[wrlist[[i]],wzlist,a,p,e,xg,const],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz)
]
...
\[Delta]YzoverYzgsparDHcoeff[nmax_,kmax_,a_,p_,e_,xg_,const_,\[Delta]const_]:=Module[{stepsr,stepsz,wrlist,wzlist,ExpniTable,ExpjkTable},
	...
	(ExpniTable . (Table[\[Delta]YzoverYzgsparDH[wrlist[[i]],wzlist,a,p,e,xg,const,\[Delta]const],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz)
]
...
\[Delta]YroverYrgsortpluscoeff[nmax_,kmax_,a_,p_,e_,xg_,const_]:=Module[{stepsr,stepsz,wrlist,wzlist,ExpniTable,ExpjkTable,\[Psi]pbar},
	...
	(ExpniTable . (Table[1/2 (\[Delta]YroverYrgsortCos\[Psi][wrlist[[i]],wzlist,a,p,e,xg,const]+I*\[Delta]YroverYrgsortSin\[Psi][wrlist[[i]],wzlist,a,p,e,xg,const])(Cos[\[Psi]pbar[wrlist[[i]],wzlist]]-I*Sin[\[Psi]pbar[wrlist[[i]],wzlist]]),{i,stepsr}]) . ExpjkTable) 1/(stepsr*stepsz)
]
...
\[Delta]YzoverYzgsortpluscoeff[nmax_,kmax_,a_,p_,e_,xg_,const_]:=Module[{stepsr,stepsz,wrlist,wzlist,ExpniTable,ExpjkTable,\[Psi]pbar},
	...
	(ExpniTable . (Table[1/2 (\[Delta]YzoverYzgsortCos\[Psi][wrlist[[i]],wzlist,a,p,e,xg,const]+I*\[Delta]YzoverYzgsortSin\[Psi][wrlist[[i]],wzlist,a,p,e,xg,const])(Cos[\[Psi]pbar[wrlist[[i]],wzlist]]-I*Sin[\[Psi]pbar[wrlist[[i]],wzlist]]),{i,stepsr}]) . ExpjkTable) 1/(stepsr*stepsz)
]
...
dtsparFCd\[Lambda]coefffun[nmax_,kmax_,a_,p_,e_,xg_,const_,coeffrad_,coeffpol_]:=Module[{stepsr,stepsz,wrlist,wzlist,ExpniTable,ExpjkTable},
	...
	(ExpniTable . (Table[dtsparFCd\[Lambda]fun[wrlist[[i]],wzlist,a,p,e,xg,const,coeffrad,coeffpol],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz)
]
...
dtsparDHd\[Lambda]coefffun[nmax_,kmax_,a_,p_,e_,xg_,const_,\[Delta]const_,coeffrad_,coeffpol_]:=Module[{stepsr,stepsz,wrlist,wzlist,ExpniTable,ExpjkTable},
	...
	(ExpniTable . (Table[dtsparDHd\[Lambda]fun[wrlist[[i]],wzlist,a,p,e,xg,const,\[Delta]const,coeffrad,coeffpol],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz)
	]
...
d\[Phi]sparFCd\[Lambda]coefffun[nmax_,kmax_,a_,p_,e_,xg_,const_,coeffrad_,coeffpol_]:=Module[{stepsr,stepsz,wrlist,wzlist,ExpniTable,ExpjkTable},
	...
	(ExpniTable . (Table[d\[Phi]sparFCd\[Lambda]fun[wrlist[[i]],wzlist,a,p,e,xg,const,coeffrad,coeffpol],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz)
]
...
d\[Phi]sparDHd\[Lambda]coefffun[nmax_,kmax_,a_,p_,e_,xg_,const_,\[Delta]const_,coeffrad_,coeffpol_]:=Module[{stepsr,stepsz,wrlist,wzlist,ExpniTable,ExpjkTable},
	...
	(ExpniTable . (Table[d\[Phi]sparDHd\[Lambda]fun[wrlist[[i]],wzlist,a,p,e,xg,const,\[Delta]const,coeffrad,coeffpol],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz)
]
...
dtsortplusd\[Lambda]coefffun[nmax_,kmax_,a_,p_,e_,xg_,const_,coeffrad_,coeffpol_]:=Module[{stepsr,stepsz,wrlist,wzlist,ExpniTable,ExpjkTable},
	...
	(ExpniTable . (Table[dtsortplusd\[Lambda]fun[wrlist[[i]],wzlist,a,p,e,xg,const,coeffrad,coeffpol],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz)
]
...
dtsortminusd\[Lambda]coefffun[nmax_,kmax_,a_,p_,e_,xg_,const_,coeffrad_,coeffpol_]:=Module[{stepsr,stepsz,wrlist,wzlist,ExpniTable,ExpjkTable},
	...
	(ExpniTable . (Table[dtsortminusd\[Lambda]fun[wrlist[[i]],wzlist,a,p,e,xg,const,coeffrad,coeffpol],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz)
]
...
KerrSpinOrbitCorrectionDHPar[a_, p_, e_, x_, nmax_?(IntegerQ[#] && # > 0&), kmax_?EvenQ]:=Module[{EEg,Lzg,KKg,constmot,\[CapitalUpsilon]tg,\[CapitalUpsilon]rg,\[CapitalUpsilon]zg,\[CapitalUpsilon]\[Phi]g,\[Delta]EEg,\[Delta]Lzg,\[Delta]KKg,\[Delta]constmot,\[CapitalUpsilon]ts,\[CapitalUpsilon]rs,\[CapitalUpsilon]zs,\[CapitalUpsilon]\[Phi]s,stepsr,stepsz,\[CapitalDelta]tspar,\[CapitalDelta]\[Phi]spar,\[Delta]rpar,\[Delta]zpar,
	...
	dtrgd\[Lambda]coeff=(ExpniTable . Vtrgfun[wrlist,a,p,e,x,constmot])/stepsr;
	dtzgd\[Lambda]coeff=(Vtzgfun[wzlist,a,p,e,x,constmot] . ExpjkTable)/stepsz;	
	d\[Phi]rgd\[Lambda]coeff=(ExpniTable . V\[Phi]rgfun[wrlist,a,p,e,x,constmot])/stepsr;
	d\[Phi]zgd\[Lambda]coeff=(V\[Phi]zgfun[wzlist,a,p,e,x,constmot] . ExpjkTable)/stepsz;
	
	Print["Calculating \!\(\*SubscriptBox[\(\[Xi]\), \(r\)]\), \!\(\*SubscriptBox[\(\[Xi]\), \(z\)]\) Fourier coefficients"];
	\[Xi]rparcoeff=(ExpniTable . (Table[\[Delta]YroverYrgsparDH[wrlist[[i]],wzlist,a,p,e,x,constmot,\[Delta]constmot],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz);
	\[Xi]zparcoeff=(ExpniTable . (Table[\[Delta]YzoverYzgsparDH[wrlist[[i]],wzlist,a,p,e,x,constmot,\[Delta]constmot],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz);
	...
	dtspard\[Lambda]coeff=(ExpniTable . (Table[dtsparDHd\[Lambda]fun[wrlist[[i]],wzlist,a,p,e,x,constmot,\[Delta]constmot,\[Xi]rparcoeff,\[Xi]zparcoeff],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz);
	...
	d\[Phi]spard\[Lambda]coeff=(ExpniTable . (Table[d\[Phi]sparDHd\[Lambda]fun[wrlist[[i]],wzlist,a,p,e,x,constmot,\[Delta]constmot,\[Xi]rparcoeff,\[Xi]zparcoeff],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz);
	...
	<|
	 ...
	 "\[Xi]par"->{\[Xi]rparcoeff,\[Xi]zparcoeff}
	|>
]
...
KerrSpinOrbitCorrectionFCPar[a_, p_, e_, x_, nmax_?(IntegerQ[#] && # > 0&), kmax_?EvenQ]:=Module[{EEg,Lzg,KKg,constmot,\[CapitalUpsilon]tg,\[CapitalUpsilon]rg,\[CapitalUpsilon]zg,\[CapitalUpsilon]\[Phi]g,\[Delta]EEg,\[Delta]Lzg,\[Delta]KKg,\[CapitalUpsilon]ts,\[CapitalUpsilon]rs,\[CapitalUpsilon]zs,\[CapitalUpsilon]\[Phi]s,stepsr,stepsz,\[CapitalDelta]tspar,\[CapitalDelta]\[Phi]spar,\[Delta]rpar,\[Delta]zpar,
	...
	Print["Calculating \!\(\*SubscriptBox[\(\[Xi]\), \(r\)]\), \!\(\*SubscriptBox[\(\[Xi]\), \(z\)]\) Fourier coefficients"];
	\[Xi]rparcoeff=(ExpniTable . (Table[\[Delta]YroverYrgsparFC[wrlist[[i]],wzlist,a,p,e,x,constmot],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz);
	\[Xi]zparcoeff=(ExpniTable . (Table[\[Delta]YzoverYzgsparFC[wrlist[[i]],wzlist,a,p,e,x,constmot],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz);
	
	(* spin correction radial and polar frequencies *)
	\[CapitalUpsilon]rs=\[CapitalUpsilon]rg*\[Xi]rparcoeff[[nmax+1,kmax+1]];
	\[CapitalUpsilon]zs=\[CapitalUpsilon]zg*\[Xi]zparcoeff[[nmax+1,kmax+1]];
	Print["Calculating Fourier coefficients of \!\(\*SubscriptBox[\(dt\), \(s\)]\)/d\[Lambda]"];
	dtspard\[Lambda]coeff=(ExpniTable . (Table[dtsparFCd\[Lambda]fun[wrlist[[i]],wzlist,a,p,e,x,constmot,\[Xi]rparcoeff,\[Xi]zparcoeff],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz);
	\[CapitalUpsilon]ts=dtspard\[Lambda]coeff[[nmax+1,kmax+1]];
	Print["Calculating Fourier coefficients of \!\(\*SubscriptBox[\(d\[Phi]\), \(s\)]\)/d\[Lambda]"];
	d\[Phi]spard\[Lambda]coeff=(ExpniTable . (Table[d\[Phi]sparFCd\[Lambda]fun[wrlist[[i]],wzlist,a,p,e,x,constmot,\[Xi]rparcoeff,\[Xi]zparcoeff],{i,stepsr}]) . ExpjkTable)/(stepsr*stepsz);
	\[CapitalUpsilon]\[Phi]s=d\[Phi]spard\[Lambda]coeff[[nmax+1,kmax+1]];
...
KerrSpinOrbitCorrectionDHMapFC[a_, p_, e_, x_, nmax_?(IntegerQ[#] && # > 0&), kmax_?EvenQ]:=Module[{EEg,Lzg,KKg,constmot,\[CapitalUpsilon]tg,\[CapitalUpsilon]rg,\[CapitalUpsilon]zg,\[CapitalUpsilon]\[Phi]g,\[Delta]EEg,\[Delta]Lzg,\[Delta]KKg,\[Delta]constmot,devtime,devrad,devpol,devphi,stepsr,stepsz,
	...
	\[Eta]trcoeff=(ExpniTable . \[Eta]trfun[wrlist,a,p,e,x,constmot,\[Delta]constmot])/stepsr;
	\[Eta]tzcoeff=(\[Eta]tzfun[wzlist,a,p,e,x,constmot,\[Delta]constmot] . ExpjkTable)/stepsz;	
	\[Eta]\[Phi]rcoeff=(ExpniTable . \[Eta]\[Phi]rfun[wrlist,a,p,e,x,constmot,\[Delta]constmot])/stepsr;
	\[Eta]\[Phi]zcoeff=(\[Eta]\[Phi]zfun[wzlist,a,p,e,x,constmot,\[Delta]constmot] . ExpjkTable)/stepsz;
...
KerrSpinOrbitCorrectionOrt[a_, p_, e_, x_, nmax_?(IntegerQ[#] && # > 0&), kmax_?EvenQ]:=Module[{EEg,Lzg,KKg,constmot,\[CapitalUpsilon]tg,\[CapitalUpsilon]rg,\[CapitalUpsilon]zg,\[CapitalUpsilon]\[Phi]g,\[Delta]EEg,\[Delta]Lzg,\[Delta]KKg,\[Delta]constmot,\[CapitalUpsilon]p,stepsr,stepsz,
	...
	\[Xi]rortpluscoeff=(ExpniTable . (1/2(\[Delta]YroverYrgsortCos\[Psi]list+I*\[Delta]YroverYrgsortSin\[Psi]list)Aminus) . ExpjkTable)1/(stepsr*stepsz);
	\[Xi]rortminuscoeff=(ExpniTable . (1/2(\[Delta]YroverYrgsortCos\[Psi]list-I*\[Delta]YroverYrgsortSin\[Psi]list)Aplus) . ExpjkTable)1/(stepsr*stepsz);	
	\[Xi]zortpluscoeff=(ExpniTable . (1/2(\[Delta]YzoverYzgsortCos\[Psi]list+I*\[Delta]YzoverYzgsortSin\[Psi]list)Aminus) . ExpjkTable)1/(stepsr*stepsz);  
	\[Xi]zortminuscoeff=(ExpniTable . (1/2(\[Delta]YzoverYzgsortCos\[Psi]list-I*\[Delta]YzoverYzgsortSin\[Psi]list)Aplus) . ExpjkTable)1/(stepsr*stepsz);
	...
	dtsortplusd\[Lambda]coeff=(ExpniTable . dtsortplusd\[Lambda]list . ExpjkTable)/(stepsr*stepsz);
	dtsortminusd\[Lambda]coeff=(ExpniTable . dtsortminusd\[Lambda]list . ExpjkTable)/(stepsr*stepsz);
	...
	d\[Phi]sortplusd\[Lambda]coeff=(ExpniTable . d\[Phi]sortplusd\[Lambda]list . ExpjkTable)/(stepsr*stepsz);
	d\[Phi]sortminusd\[Lambda]coeff=(ExpniTable . d\[Phi]sortminusd\[Lambda]list . ExpjkTable)/(stepsr*stepsz);
